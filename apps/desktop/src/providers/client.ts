// Consumer-facing LLM API (naming convention rule 4): streamModel (the
// provider-agnostic router), buffered collectText/chatOnce, and the heal loop.
// Wire plumbing lives in transport.ts; per-provider mapping in the adapters.
