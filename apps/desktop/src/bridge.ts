...
import type { ToolSchema, ToolCallRequest, ToolResult, ToolCtx, MediaModelConfig } from "./core/tools/types.ts";

export type { ToolSchema, ToolCallRequest, ToolResult, ToolCtx, MediaModelConfig };
...
export interface HarnessApi {
  ...
  media: {
    ...
    models(cfg: MediaModelConfig): Promise<MediaModelsResult>;
  };
